...
public class Ex14_11 {
    public static void main(String[] args) {
        ...
        System.out.printf("1.  단순그룹화(반별로그룹화)%n");
        ...
        for(Student3.Level key : keySet){
            ...
            for(Student3 s : stuByLevel.get(key)) System.out.println(s);
        ...
        System.out.printf("%n5.다중그룹화(학년별, 반별 1등)");
        ...
        System.out.printf("%n5.다중그룹화(학년별, 반별 성적그룹)");
        Map<String, Set<Student3.Level>>  stuByScoreGruop =
                Stream.of(stuArr)
        ...
        Set<String> keySet2 = stuByScoreGruop.keySet();


        for(String key : keySet2) {
            System.out.println("["+key+"]"+ stuByScoreGruop.get(key));
        }
